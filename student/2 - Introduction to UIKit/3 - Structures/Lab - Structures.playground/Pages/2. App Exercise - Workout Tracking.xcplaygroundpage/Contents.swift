...
let updatedRun = RunningWorkout(distance: 2396, time: 15.3, elevation: 94)
print("I ran \(updatedRun.distance) meters in \(updatedRun.time) minutes, gaining \(updatedRun.elevation) meters of elevation.")
