...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName:"Swastik", email:"swastik@gmail.com", age:20)
    static func logIn(user:User) {
        currentUser=user
        print("\(currentUser.userName) has logges In")
    }
}
 ...
 */
var user2=User(userName:"Shubham", email:"shubham@gmail.com", age:21)
