...
let newDimensions = GPS(latitude: 51.514004, longitude: 0.125226)
print("Latitude: \(newDimensions.latitude)")
print("Longitude: \(newDimensions.longitude)")
...
let favoriteBook = Book(title: "", author: "", pages:0 , price: 0)
