...
let favoriteBook = Books(title: "The Alchemist", author: "Paulo Coelho", pages: 222, price: 12.99)
...
let macBookPro13 = Laptop(yearPurchased: 2015)
let macBookPro15 = Laptop(screenSize: 15, yearPurchased: 2018)
...
struct Height {
    ...
    init(heightInInches: Double, heightInCentimeters: Double = 0) {
...
let myHeight=Height(heightInInches: 68)
