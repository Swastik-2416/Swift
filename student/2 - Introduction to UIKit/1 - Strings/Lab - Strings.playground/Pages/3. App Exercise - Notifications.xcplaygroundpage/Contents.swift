...
let newBest = 15125
let names="Swastik"
let congratulations = "Congratulations, \(names) You beat your previous daily high score of \(previousBest) steps by walking \(newBest) steps yesterday!"
