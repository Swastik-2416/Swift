...
func checkAge(_ ageString: String) -> Int? {
    // Try to convert the string input to an Int
    if let age = Int(ageString) {
        if age >= 18 {
            print("Welcome!")
        } else {
...
let result2 = checkAge("21")
print("Returned value:", result2)
...
func purchaseItem(named item: String) -> Double? {
...
let item1 = "Juice"
let cost1 = purchaseItem(named: item1)
print("\(item1) cost:", cost1)


let item2 = "Donuts"
let cost2 = purchaseItem(named: item2)
print("\(item2) cost:", cost2)
