...
int userAge: Int? = Int(userInputAge)
...
//print(userAge)
//Explanation:
// userAge is nil because "34e" is not a valid integer representation.
// The Int initializer fails to convert invalid strings and returns nil instead.
...
let userAge: Int? = Int(userInputAge)
print(userAge)
print(userAge!) // Output: 34


// The value prints as Optional(34) because userAge is still an Int? (optional type)
// It means that userAge *may or may not* contain a value.
